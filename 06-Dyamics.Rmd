...
Let $f$ be the probability measure prserving map on $(X,\mathcal{A},\mu)$. If $A$ is measurable then $\mu$ almost everywhere $x\in A,\exists n\in \mathbb{N}$ such that $f^n(x)\in A$.
```
